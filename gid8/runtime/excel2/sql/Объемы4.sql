...
TEMP_PROD_OUT,
  (
SELECT IST1.kod_ist AS kod_ist, 1 AS num  FROM [Источник тепла] IST1
UNION ALL SELECT IST1.kod_ist, 2          FROM [Источник тепла] IST1
UNION ALL SELECT IST1.kod_ist, 3          FROM [Источник тепла] IST1
) TAB
