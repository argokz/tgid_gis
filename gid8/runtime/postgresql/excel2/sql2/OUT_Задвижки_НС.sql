SELECT  
--  l.id,
  eci.name as kod_p, ni.externalNodeName as uzel_p, 
  esi.name as pr_p,
  ...
  a8 AS name_soder_zd,
  dampers.dispatcherSwitch as name_zd,
  das.name as sost, 
  dampers.partDempOpen,
  a9, 
...
JOIN pumpStations ON pumpStations.nodeID=ni.id

join damperArmatureStates das on das.id = damperArmatureStateID
