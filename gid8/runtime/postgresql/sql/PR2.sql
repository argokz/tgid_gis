...
rc.contCalcHLdep as f_otoplz,
rc.contcalcHLindep as f_otopln,
rc.contRelLoadFacade as f_otn_fs,
rc.contInternHD as f_otopl_tp,
rc.perspCalcHLdep as p_otoplz,
rc.perspcalcHLindep as p_otopln,
rc.perspRelLoadFacade as p_otn_fs,
rc.perspInternHD as p_otopl_tp,
rc.calcHLventil as ventil,
rc.expendHWpart as dolja_vent,
rc.contCalcHLventil as f_ventil,
rc.perspCalcHLventil as p_ventil,
rc.avgHLcond as kondiz,
rc.contAvgHLcond as f_kondiz,
rc.perspAvgHLcond as p_kondiz,
rc.avgHLcloseSys as txz,
rc.avgHLopenSysFlow as txop,
rc.avgHLopenSysRet as txoo,
rc.contAvgHLcloseSys as f_txz,
rc.contAvgHLopenSysFlow as f_txop,
rc.contAvgHLopenSysRet as f_txoo,
rc.perspAvgHLclose as p_txz,
rc.perspAvgHLopenFlow as p_txop,
rc.contAvgHLopenRet as p_txoo,
...
rc.contAvgHLGVSopenFlow as f_gvop,
rc.contAvgHLGVSopenRet as f_gvoo,
rc.contAvgHLGVScloseParall as f_gvpr,
rc.contAvgHLGVScloseMix as f_gvsm,
rc.contAvgHLGVScloseConseq as f_gvps,
rc.contAvgHLGVSclosePreon as f_gvpw,
rc.perspAvgHLGVSopenFlow as p_gvop,
rc.perspAvgHLGVSopenRet as p_gvoo,
rc.perspAvgHLGVScloseParall as p_gvpr,
rc.perspAvgHLGVScloseMix as p_gvsm,
rc.perspAvgHLGVScloseConseq as p_gvps,
rc.perspAvgHLGVSclosePreon as p_gvpw,
