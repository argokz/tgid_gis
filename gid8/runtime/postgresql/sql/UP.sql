SELECT
    n.id,
    ec.name as kod, n.externalNodeName as uzel, es.name as "Признак теплопровода узла подпитки", 
    ...
    chargeExpend as r_z, dischargeExpend as r_r, setPressRet as napor
--    , n.fileID
from refillNodes rn
...
join externalSigns es on es.id = rn.externalSignID
