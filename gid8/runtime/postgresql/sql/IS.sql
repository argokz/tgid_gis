...
hs.hSourcePower as n_rasp, 
hs.hSourcePowerInst as n_ustan, 
hs.hSeasonBeginDate as begin_year, 
hs.hSeasonEndDate as end_year, 
hs.temperDWflowSummer as t1_leto, 
hs.temperDWretSummer as t2_leto, 
hs.specVolHS as a24, 
hs.specVolVent as a25, 
--hs.expendDWnorm1 as G1n_ist_1, 
--hs.expendDWnorm2 as G1n_ist_2, 
--hs.expendDWnorm3 as G1n_ist_3, 
--hs.expendDWnorm4 as G1n_ist_4, 
--hs.expendDWnorm5 as G1n_ist_5, 
hs.managerPhone as phone_manager, hs.controllerPhone as phone_controller, 
--hs.heightTubeMark as "Высотная отметка оси трубы", 
--hs.heightAreaMark as "Высотная отметка местности", 
cs.name as sost, 
o.name as "Оператор", 
