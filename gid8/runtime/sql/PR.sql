...
rc.houseNumber as 'Номер дома',
--rc.contractNumber as 'Номер договора',
...
--  heatPointID,
rc.note_1 AS 'Приложение 1',
rc.note_2 AS 'Приложение 2',
...
left join streets on streets.id=rc.streetID
