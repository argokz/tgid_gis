...
gc.calcHLdep as 'otopl_zco',gc.calcInternHDdep as 'otopl_tp_zco',
gc.calcTempDep as 'Tr_tv_co_zco',gc.mixFactCoeffDep as 'uf_zco',
gc.calcHLindep as 'otopl_nco',gc.calcInternHDindep as 'otopl_tp_nco',

gc.calcTempIndep as 'Tr_tv_co_nco',gc.mixFactCoeffIndep as 'uf_nco',
gc.calcHLventil as 'ventil_cv',
gc.calcHLcond as 'kondiz',
gc.calcHLcloseSys as 'txz',gc.calcHLopenSysFlow as 'txop',gc.calcHLopenSysRet as 'txoo',
gc.expendHWpart as 'dolja_vent_cv',gc.calcTempHA as 'Tr_tv_cv',
gc.calcHLparall as 'otopl_pr',gc.internHDparall as 'otopl_tp_pr',
gc.calcHLGVSparall as 'gv_pr',
gc.hourIrregCoeffParall as 'gvs_max_pr',
...
gc.AMRdepParall as 'uf_zco_pr',gc.calcHLmix as 'otopl_sm',gc.internHDmix as 'otopl_tp_sm',

gc.calcHLGVSmix as 'gv_sm',

gc.hourIrregCoeffMix as 'gvs_max_sm',gc.avgHLcompMix as 'rez_sm',gc.tempRecircPipeMix as 'T_pot_rez_sm',
gc.calcTempHRmix as 'Tr_tv_co_sm',gc.calcTempHWDOmix as 'Tr_gvs_sm',gc.AMRdepMix as 'uf_zco_sm',gc.calcHLconseq as 'otopl_ps',
gc.internHDconseq as 'otopl_tp_ps',
gc.schemeConseqID as 'cx_co_ps',gc.calcHLGVSconseq as 'gv_ps',
gc.hourIrregCoeffConseq as 'gvs_max_ps',gc.avgHLcompconseq as 'rez_ps',gc.tempRecircPipeConseq as 'T_pot_rez_ps',
...
gc.internHDpreon as 'otopl_tp_pw',
gc.schemePreonID as 'cx_co_pw',gc.calcHLGVSpreon as 'gv_pw',
gc.hourIrregCoeffPreon as 'gvs_max_pw',gc.avgHLcompPreon as 'rez_pw',gc.tempRecircPipePreon as 'T_pot_rez_pw',
...
gc.hourIrregCoeffOpen as 'gvs_max_o',gc.avgHLcompOpen as 'rez_op',gc.tempRecircPipeOpen as 'T_pot_rez_op',
...
-- n.x as 'x', n.y as 'y', 
n.nodeName as 'Наименование', n.scheme as 'Схема', n.gpsCoords as 'GPS координаты', n.inventNumber as 'Инвентарный номер', n.belongMagistralSite as 'Принадлежность участку МС', n.belongDistSite as 'Принадлежность РС', n.magistralSite as 'Участок МС', n.distSite as 'Участок РС', n.belongHN as 'Принадлежность тепловым сетям', n.passport as 'Паспорт'
--, n.isLoaded as 'name_typ', n.fileID
