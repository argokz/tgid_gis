select 
    ...
    obj.granitsa_razdela as 'Граница раздела',
    ...
    fio_otvetstvennyj_po_snip_kontura_istochnika_tepla as 'ФИО ответственного за обеспечение работы электрооборудования',
    dolzhnost_otvetstvennyj_po_snip_kontura_istochnika_tepla.znachenie as 'Должность за обеспечение работы электрооборудования',
    podrazdelenie_otvetstvennyj_po_snip_kontura_istochnika_tepla.name as 'Подразделение за обеспечение работы электрооборудования',
...
where obj.sostoyanie_opresID IN ($stateID$)
AND
  (
