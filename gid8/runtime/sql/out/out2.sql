...
IIF(id1=1, kod1, '') AS kod11,
IIF(id1=1, name1, '') AS name11,
IIF(id2=1, kod2, '') AS kod21,
IIF(id2=1, name2, '') AS name21,
po,
pih,
r
...
row_number() over(partition by n0.id order by ec0.name, n0.externalNodeName, ec.name,n.externalNodeName,n.externalSignID) as id1,
row_number() over(partition by n.externalNodeName order by n0.externalNodeName, n.externalNodeName,n.externalSignID) as id2,
