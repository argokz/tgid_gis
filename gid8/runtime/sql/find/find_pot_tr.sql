...
left join realConsumers rc on rc.nodeID=n.id and rc.calcTemperatureID is null
left join generalizedConsumers gc on gc.nodeID=n.id and gc.calcTemperatureID is null
