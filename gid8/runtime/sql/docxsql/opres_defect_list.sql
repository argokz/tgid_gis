...
FORMAT(d.data_nachala_remonta,'dd.MM.yyyy' ) as 'Дата начала ремонтных работ',
FORMAT(d.data_zaversheniya_remonta,'dd.MM.yyyy' ) as 'Дата завершения ремонтных работ',
...
join defect d ON l.shape.STDistance(d.shape) < 0.1 and d.opresID = obj.id
