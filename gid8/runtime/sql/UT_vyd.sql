SELECT top 2147483647 l.id,
 pssF.name as 'key_ut_p',
 pssR.name as 'key_ut_o',
 n1.nodeName as 'Начальный узел',
 n2.nodeName as 'Конечный узел',
 s.name as 'standard',
...
hps.tubeCharactID as '__Характеристика трубы',
hps.tubeTypeID as '__Тип трубы',
hps.tubeMaterial as 'Материал трубы',
hps.temperMax as 'Максимально допустимая температура',
hps.factoryManufID as '__Завод изготовитель',
hps.externMaterialID as '__Материал наружного покрытия',
hps.isolationTypeID as '__Тип изоляции',
hps.externCoverThick as 'Толщина наружного покрытия, мм',
hps.anticorrMaterialID as '__Материал антикоррозийного покрытия',
hps.magistralSite as 'Участок МС',
hps.distSite as 'Участок РС',
hps.exploitReg as 'Район эксплуатации',
hps.net as 'Сеть',
hps.magistral as 'Магистраль',
...
AND l.id IN (SELECT ID from $vyd$)
