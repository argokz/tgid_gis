...
he.location as 'mesto',he.heatExchType as 'tip_to',he.heatExchCode as 'kod_to',
l.location as 'mesto', l.hydroRes as 'sopr', l.registNum as 'registr', l.firstPICdate as 'datenew', l.lastMaintDate as 'dateend_to', l.displaySign as 'podp', 
l.archiveChangeDate as 'date_archives',
st.name as 'sost', org.name as 'Владелец', o.name as 'operator', ni.fileID
from heatExchangers he
join linesobj l on l.id = he.lineID
...
join states st on st.id = he.stateID
