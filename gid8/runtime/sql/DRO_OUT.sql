...
l.id,
  ...
  case dro_out.externalSignLineID
        when 1 then ' '
        when 2 then 'Ï'
        when 3 then 'Î'
        when 4 then 'Ï'
  ...
  sos,
  a8, ras, a10, a11, a12, a13, a14, a15
from DRO_OUT
join linesobj l on l.id = dro_out.lineID
join nodes n1 on n1.id = l.nodeID1
join nodes n2 on n2.id = l.nodeID2
left join realconsumers rc on rc.nodeid=n1.internalNodeID
...
join externalSignLine esl on esl.id = dro_out.externalSignLineID
