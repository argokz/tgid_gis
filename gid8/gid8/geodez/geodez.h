...
void m2m_42_WGS84(SystemCoord& system_coord, double X1, double Y1, double& xx, double& yy, bool shift=true);
void m2m_WGS84_42(SystemCoord& system_coord, double X1, double Y1, double& xx, double& yy, bool shift=true);
