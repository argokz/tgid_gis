...
void write_block_head(FILE *dxf, const char *name, int h)
{
...
void write_minimun(FILE* dxf, double x1, double y1, double x2, double y2)
{
    init_handle();
...
/////////////////////////////////////////////////
    ...
    //------------
    h_MS = write_block_record(dxf, "*Model_Space", handle_parent);
    h_PS = write_block_record(dxf, "*Paper_Space", handle_parent);
