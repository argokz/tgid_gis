...
void write_pline(FILE *dxf, int n, double *x, double *y, const char *layer);
void write_text(FILE *dxf, double x, double y, const char *txt, double ang = 0., double ht = 1., int just = 0);
void write_text(FILE *dxf, double x, double y, const char *txt, double angle, double ht, int just, const char *layer);
void write_mtext(FILE *dxf, double x, double y, const char *txt, double angle, double ht = 1, int just = 0);
...
void write_insert(FILE *dxf, const char *name, double x, double y, const char *layer);
