...
-- connect_node  <-  public.connectnodes  (1527 строк)
...
CREATE INDEX IF NOT EXISTS connect_node_src_idx ON net.connect_node (src_id);
...
-- regulator_flow  <-  public.consumptregulators  (7 строк)
CREATE TABLE IF NOT EXISTS net.regulator_flow (
    id                                 bigint PRIMARY KEY DEFAULT nextval('net.obj_id_seq')
  , fragment_id                        int REFERENCES net.fragment(id)
  , geom                               geometry(Point, 9998) NOT NULL
  , removed_at                         timestamptz
  ...
  , distsite                           int
  , registnumber                       text
  , regconsmean                        double precision
  , workattrid                         int
  , hydroresopen                       double precision
  , hydroresclose                      double precision
  , regvalvecap                        int
  , relatleakage                       double precision
  , plumsconsumption                   double precision
  , opc                                text
  , deltah                             double precision
  , regulatorstateid                   int
);
CREATE INDEX IF NOT EXISTS regulator_flow_geom_idx ON net.regulator_flow USING gist (geom);
CREATE INDEX IF NOT EXISTS regulator_flow_frag_idx ON net.regulator_flow (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS regulator_flow_src_idx ON net.regulator_flow (src_id);
DROP TRIGGER IF EXISTS regulator_flow_reg ON net.regulator_flow;
CREATE TRIGGER regulator_flow_reg AFTER INSERT OR DELETE ON net.regulator_flow
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('regulator_flow');

-- direction_deployed  <-  public.deployeddirections  (2210 строк)
CREATE TABLE IF NOT EXISTS net.direction_deployed (
    id                                 bigint PRIMARY KEY DEFAULT nextval('net.obj_id_seq')
  , fragment_id                        int REFERENCES net.fragment(id)
  , geom                               geometry(Point, 9998) NOT NULL
  , removed_at                         timestamptz
...
CREATE INDEX IF NOT EXISTS direction_deployed_geom_idx ON net.direction_deployed USING gist (geom);
CREATE INDEX IF NOT EXISTS direction_deployed_frag_idx ON net.direction_deployed (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS direction_deployed_src_idx ON net.direction_deployed (src_id);
DROP TRIGGER IF EXISTS direction_deployed_reg ON net.direction_deployed;
CREATE TRIGGER direction_deployed_reg AFTER INSERT OR DELETE ON net.direction_deployed
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('direction_deployed');

-- consumer_general  <-  public.generalizedconsumers  (29051 строк)
...
CREATE INDEX IF NOT EXISTS consumer_general_src_idx ON net.consumer_general (src_id);
...
-- heat_chamber  <-  public.heatchambers  (91 строк)
...
CREATE INDEX IF NOT EXISTS heat_chamber_src_idx ON net.heat_chamber (src_id);
...
-- heat_source  <-  public.heatsources  (164 строк)
...
CREATE INDEX IF NOT EXISTS heat_source_src_idx ON net.heat_source (src_id);
...
-- repair_section  <-  public.kapremont_uchastki_remonta  (5 строк)
...
CREATE INDEX IF NOT EXISTS repair_section_frag_idx ON net.repair_section (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS repair_section_src_idx ON net.repair_section (src_id);
DROP TRIGGER IF EXISTS repair_section_reg ON net.repair_section;
CREATE TRIGGER repair_section_reg AFTER INSERT OR DELETE ON net.repair_section
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('repair_section');

-- manhole  <-  public.lyuki  (18392 строк)
...
CREATE INDEX IF NOT EXISTS manhole_frag_idx ON net.manhole (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS manhole_src_idx ON net.manhole (src_id);
DROP TRIGGER IF EXISTS manhole_reg ON net.manhole;
CREATE TRIGGER manhole_reg AFTER INSERT OR DELETE ON net.manhole
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('manhole');

-- support  <-  public.opora  (3611 строк)
...
CREATE INDEX IF NOT EXISTS support_frag_idx ON net.support (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS support_src_idx ON net.support (src_id);
DROP TRIGGER IF EXISTS support_reg ON net.support;
CREATE TRIGGER support_reg AFTER INSERT OR DELETE ON net.support
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('support');

-- pressure_test_defect  <-  public.opressovka_defekt  (1 строк)
...
CREATE INDEX IF NOT EXISTS pressure_test_defect_frag_idx ON net.pressure_test_defect (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS pressure_test_defect_src_idx ON net.pressure_test_defect (src_id);
DROP TRIGGER IF EXISTS pressure_test_defect_reg ON net.pressure_test_defect;
CREATE TRIGGER pressure_test_defect_reg AFTER INSERT OR DELETE ON net.pressure_test_defect
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('pressure_test_defect');

-- diameter_change  <-  public.perehod_diametra  (4 строк)
...
CREATE INDEX IF NOT EXISTS diameter_change_frag_idx ON net.diameter_change (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS diameter_change_src_idx ON net.diameter_change (src_id);
DROP TRIGGER IF EXISTS diameter_change_reg ON net.diameter_change;
CREATE TRIGGER diameter_change_reg AFTER INSERT OR DELETE ON net.diameter_change
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('diameter_change');

-- regulator_pressdrop  <-  public.pressdropregulators  (13 строк)
CREATE TABLE IF NOT EXISTS net.regulator_pressdrop (
  ...
  , distsite                           int
  , registnumber                       text
  , pressdropmean                      double precision
  , regvalvehydrores                   double precision
  , consthroughregvalve                double precision
  , thrustdropmean                     double precision
  , regvalverelcap                     int
  , maxleakageclosevalve               double precision
...
CREATE INDEX IF NOT EXISTS regulator_pressdrop_frag_idx ON net.regulator_pressdrop (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS regulator_pressdrop_src_idx ON net.regulator_pressdrop (src_id);
...
CREATE TRIGGER regulator_pressdrop_reg AFTER INSERT OR DELETE ON net.regulator_pressdrop
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('regulator_pressdrop');

-- regulator_press  <-  public.pressregulators  (509 строк)
...
CREATE INDEX IF NOT EXISTS regulator_press_src_idx ON net.regulator_press (src_id);
...
-- pump_station  <-  public.pumpstations  (227 строк)
...
CREATE INDEX IF NOT EXISTS pump_station_src_idx ON net.pump_station (src_id);
...
-- consumer_real  <-  public.realconsumers  (26202 строк)
...
CREATE INDEX IF NOT EXISTS consumer_real_src_idx ON net.consumer_real (src_id);
...
-- refill_node  <-  public.refillnodes  (1 строк)
...
CREATE INDEX IF NOT EXISTS refill_node_src_idx ON net.refill_node (src_id);
...
-- press_set_node  <-  public.setpressnodes  (5740 строк)
CREATE TABLE IF NOT EXISTS net.press_set_node (
    id                                 bigint PRIMARY KEY DEFAULT nextval('net.obj_id_seq')
  , fragment_id                        int REFERENCES net.fragment(id)
  , geom                               geometry(Point, 9998) NOT NULL
  , removed_at                         timestamptz
...
CREATE INDEX IF NOT EXISTS press_set_node_geom_idx ON net.press_set_node USING gist (geom);
CREATE INDEX IF NOT EXISTS press_set_node_frag_idx ON net.press_set_node (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS press_set_node_src_idx ON net.press_set_node (src_id);
DROP TRIGGER IF EXISTS press_set_node_reg ON net.press_set_node;
CREATE TRIGGER press_set_node_reg AFTER INSERT OR DELETE ON net.press_set_node
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('press_set_node');

-- valve_3way  <-  public.threewayvalves  (14 строк)
...
CREATE INDEX IF NOT EXISTS valve_3way_src_idx ON net.valve_3way (src_id);
...
-- pipe_turn  <-  public.ugol_povorota_truboprovoda  (25214 строк)
...
CREATE INDEX IF NOT EXISTS pipe_turn_frag_idx ON net.pipe_turn (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS pipe_turn_src_idx ON net.pipe_turn (src_id);
DROP TRIGGER IF EXISTS pipe_turn_reg ON net.pipe_turn;
CREATE TRIGGER pipe_turn_reg AFTER INSERT OR DELETE ON net.pipe_turn
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('pipe_turn');

-- building_inlet  <-  public.vvod_v_zdanie  (5463 строк)
...
CREATE INDEX IF NOT EXISTS building_inlet_frag_idx ON net.building_inlet (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS building_inlet_src_idx ON net.building_inlet (src_id);
DROP TRIGGER IF EXISTS building_inlet_reg ON net.building_inlet;
CREATE TRIGGER building_inlet_reg AFTER INSERT OR DELETE ON net.building_inlet
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('building_inlet');

-- metering_device  <-  public.wdodevices  (3385 строк)
CREATE TABLE IF NOT EXISTS net.metering_device (
    id                                 bigint PRIMARY KEY DEFAULT nextval('net.obj_id_seq')
  , fragment_id                        int REFERENCES net.fragment(id)
  , geom                               geometry(Point, 9998) NOT NULL
  , removed_at                         timestamptz
...
CREATE INDEX IF NOT EXISTS metering_device_geom_idx ON net.metering_device USING gist (geom);
CREATE INDEX IF NOT EXISTS metering_device_frag_idx ON net.metering_device (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS metering_device_src_idx ON net.metering_device (src_id);
DROP TRIGGER IF EXISTS metering_device_reg ON net.metering_device;
CREATE TRIGGER metering_device_reg AFTER INSERT OR DELETE ON net.metering_device
    FOR EACH ROW EXECUTE FUNCTION net.reg_node_sync('metering_device');

-- node_plain  <-  public.nodes  (остаток строк)
...
CREATE INDEX IF NOT EXISTS node_plain_src_idx ON net.node_plain (src_id);
...
-- air_heater  <-  public.airheaters  (91 строк)
...
CREATE INDEX IF NOT EXISTS air_heater_src_idx ON net.air_heater (src_id);
...
-- damper  <-  public.dampers  (14868 строк)
...
CREATE INDEX IF NOT EXISTS damper_src_idx ON net.damper (src_id);
...
-- diaphragm  <-  public.diaphragms  (16718 строк)
...
CREATE INDEX IF NOT EXISTS diaphragm_src_idx ON net.diaphragm (src_id);
...
-- elevator  <-  public.elevators  (2754 строк)
...
CREATE INDEX IF NOT EXISTS elevator_src_idx ON net.elevator (src_id);
...
-- heat_exchanger  <-  public.heatexchangers  (232 строк)
...
CREATE INDEX IF NOT EXISTS heat_exchanger_src_idx ON net.heat_exchanger (src_id);
...
-- pipe_section  <-  public.heatpipesections  (98019 строк)
...
CREATE INDEX IF NOT EXISTS pipe_section_src_idx ON net.pipe_section (src_id);
...
-- local_resistance  <-  public.localhydroresistances2  (2 строк)
...
CREATE INDEX IF NOT EXISTS local_resistance_src_idx ON net.local_resistance (src_id);
...
CREATE INDEX IF NOT EXISTS pump_src_idx ON net.pump (src_id);
...
-- radiator  <-  public.systemradiators  (622 строк)
...
CREATE INDEX IF NOT EXISTS radiator_src_idx ON net.radiator (src_id);
...
-- building_inlet_line  <-  public.vvody_v_zdanie  (5463 строк)
...
CREATE INDEX IF NOT EXISTS building_inlet_line_frag_idx ON net.building_inlet_line (fragment_id) WHERE removed_at IS NULL;
CREATE INDEX IF NOT EXISTS building_inlet_line_src_idx ON net.building_inlet_line (src_id);
CREATE INDEX IF NOT EXISTS building_inlet_line_from_idx ON net.building_inlet_line (node_from);
CREATE INDEX IF NOT EXISTS building_inlet_line_to_idx ON net.building_inlet_line (node_to);
DROP TRIGGER IF EXISTS building_inlet_line_reg ON net.building_inlet_line;
CREATE TRIGGER building_inlet_line_reg AFTER INSERT OR DELETE ON net.building_inlet_line
    FOR EACH ROW EXECUTE FUNCTION net.reg_line_sync('building_inlet_line');

-- line_plain  <-  public.linesobj  (остаток строк)
...
CREATE INDEX IF NOT EXISTS line_plain_src_idx ON net.line_plain (src_id);
...
-- pipe_reconstructed  <-  public.truby_rekonstruiruemye  (44 строк)
...
-- building  <-  public.zdaniya_2  (187203 строк)
...
-- building_consumer  <-  public.zdaniya_potrebiteley  (12466 строк)
...
-- building_tu  <-  public.zdaniya_tu  (5197 строк)
