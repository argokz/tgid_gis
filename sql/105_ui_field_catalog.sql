...
WITH specs (
    ...
    VALUES
        ...
        ('standardpumpid',     'Стандартный насос',          NULL, 'lookup', 'ref', 'standardpumps',   'id', 'name',     50, 'Оборудование'),
        ('standarddamplink',   'Стандартная задвижка',       NULL, 'lookup', 'ref', 'standarddampers', 'id', 'name',     51, 'Оборудование'),
