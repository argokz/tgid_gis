...
void KartaPovrezhdaemosti2(CWnd* wnd, int id) {
    ...
    CString doc_name;
    doc_name.Format("%s\\%s", getenv("TMP"), _TR("Карта нарушения.docx"));
    CString fname;
...
//        q.Replace("$fileID$",myId);
    ...
    inD.DoModal();
        ...
        v = ado->read("Дата обнаружения нарушения");
        ...
        v = ado->read("Наименование начального узла");
        ...
        v = ado->read("Наименование конечного узла");
        ...
        v = ado->read("Диаметр наружный, мм");
        ...
        v = ado->read("Характер повреждения");
        ...
        tC1.paragraphs().insert_paragraph(var.AllocSysString(), fNormLeft);
        v = ado->read("Причины нарушения (технические)");
        ...
        v = ado->read("Причины нарушения (организационные)");
