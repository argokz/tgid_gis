...
//    doc.paragraphs().insert_paragraph(L"График выполнения ремонтов", fBoldCenter);
    doc.paragraphs().insert_paragraph(L"ПЛАН РЕМОНТОВ", fBoldCenter);
    ...
    row.insert_cell(L"Дата ремонта	", fBoldCenter);
    ...
    row.insert_cell(L"янв", fBoldCenter);
    row.insert_cell(L"февр", fBoldCenter);
    row.insert_cell(L"март", fBoldCenter);
    row.insert_cell(L"апр", fBoldCenter);
    row.insert_cell(L"май", fBoldCenter);
    row.insert_cell(L"июнь", fBoldCenter);
    row.insert_cell(L"июль", fBoldCenter);
    row.insert_cell(L"авг", fBoldCenter);
    row.insert_cell(L"сент", fBoldCenter);
    row.insert_cell(L"окт", fBoldCenter);
    row.insert_cell(L"нояб", fBoldCenter);
    row.insert_cell(L"дек", fBoldCenter);
