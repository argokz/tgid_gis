...
Vector vect_zero = { (float)0, (float)0, (float)0 };
...
//        assert1(vect_det2(q, s1) <= 0, 26);
//        assert1(vect_det2(q, s2) >= 0, 27);
...
//    assert1(vect_len2(m) <= vect_dist2(q2, q1), 28);
    ...
    if (Vequ2(q2, p1) || Vequ2(q2, p2)) Vcpy2(S1, q2) else
        {
            ...
            S1[0] = (float) (q1[0] + t * rqx);
            S1[1] = (float) (q1[1] + t * rqy);
        }
/*
