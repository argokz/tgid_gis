...
void write_mtext(FILE *dxf, double x, double y, const char *txt, double angle, double ht = 1, int just = 0, int h = 0);

void fillpoly(FILE *dxf, int n, double *x, double *y, const char *layer, int h = 0);
void drawpoly(FILE *dxf, int n, double *x, double *y, const char *layer, int h = 0);
void line(FILE *dxf, double x1, double y1, double x2, double y2, const char *layer, int h = 0);
void rectangle(FILE *dxf, double x1, double y1, double x2, double y2, const char *layer, int h = 0);
