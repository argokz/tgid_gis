...
//                        if (en->ident != INSERT) {
                            dxf->l_xmin = min(dxf->l_xmin, en->xmin);
                            dxf->l_xmax = max(dxf->l_xmax, en->xmax);
                            dxf->l_ymin = min(dxf->l_ymin, en->ymin);
                            dxf->l_ymax = max(dxf->l_ymax, en->ymax);
//                        }
                        }
                    }
                    else {
                        ...
                        blk->xmin = min(blk->xmin, en->xmin);
                        blk->xmax = max(blk->xmax, en->xmax);
                        blk->ymin = min(blk->ymin, en->ymin);
                        blk->ymax = max(blk->ymax, en->ymax);
                    }
                }
            }
            break;
